      ...
      <div class="col-md-10 col-lg-10"> 
        ...
        <div class="row">
          <div class="col-md-8 col-lg-8">
            <h3><a class="thread-title" href="<?php echo site_url('Thread/display').'/'.$row['id'];?>"><?= $row['title']?></a></h3>
            <p><?= $row['message']?></p>
            <p>ID: <?= $row['id']?></p>
          </div>
...
<?
 	if($this->uri->segment(1)=='Forum'){
	 	echo "<script>$('#forumNav').addClass('active');</script>";
	 	//echo $this->uri->segment(1)=='Forum';
	 }
?>
